...
from photometry import PSFPhotometry, STATUS
...
def test_psfphotometry(SHARED_INPUT_DIR):
	datasource = 'ffi'
	with TemporaryDirectory() as OUTPUT_DIR:
		OUTPUT_DIR = '.'
		with PSFPhotometry(DUMMY_TARGET, SHARED_INPUT_DIR, OUTPUT_DIR, plot=True, datasource=datasource, **DUMMY_KWARG) as pho:
